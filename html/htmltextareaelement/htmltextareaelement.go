...
func GetInterface() js.Value {
	...
	singleton.Do(func() {
		...
		if htmltextareaelementinterface = js.Global().Get("HTMLTextAreaElement"); htmltextareaelementinterface.Error() != nil {
			htmltextareaelementinterface = js.Undefined()
		}

		js.Register(htmltextareaelementinterface, func(v js.Value) (interface{}, error) {
...
func (h HtmlTextAreaElement) DefaulValue() (string, error) {
...
func (h HtmlTextAreaElement) SetRangeText(replacement string, options ...interface{}) error {
	...
	err = h.Call("setRangeText", arrayJS...).Error()
	return err
}
...
func (h HtmlTextAreaElement) SetSelectionRange(selectionStart, selectionEnd string, selectionDirection ...string) error {
	...
	err = h.Call("setSelectionRange", arrayJS...).Error()
	return err
}
