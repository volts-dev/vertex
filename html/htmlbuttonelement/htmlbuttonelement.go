...
func GetInterface() js.Value {
	...
	singleton.Do(func() {
		...
		if htmlbuttonelementinterface = js.Global().Get("HTMLButtonElement"); htmlbuttonelementinterface.Error() != nil {
			htmlbuttonelementinterface = js.Undefined()
		}
		js.Register(htmlbuttonelementinterface, func(v js.Value) (interface{}, error) {
