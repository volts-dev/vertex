...
func GetInterface() js.Value {
	...
	singleton.Do(func() {
		...
		if dtinterface = js.Global().Get("DataTransfer"); dtinterface.Error() != nil {
			dtinterface = js.Undefined()
		}
		js.Register(dtinterface, func(v js.Value) (interface{}, error) {
...
func New() (DataTransfer, error) {
	...
	if dti := GetInterface(); !dti.IsUndefined() {
		...
		if obj = dti.New(); obj.Error() == nil {
			dt.SetObjectValue(obj)
		}
...
func (dt DataTransfer) Files() (filelist.FileList, error) {
	...
	if obj = dt.GetValueByKey("files"); obj.Error() == nil {
...
func (dt DataTransfer) Items() (datatranferitemlist.DataTransferItemList, error) {
	...
	if obj = dt.GetValueByKey("items"); obj.Error() == nil {
