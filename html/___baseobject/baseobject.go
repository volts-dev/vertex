...
func (b BaseObject) ConstructName() (string, error) {
	...
	var err error
	var constructname string
	if construct = b.GetValueByKey("constructor"); construct.Error() == nil {
...
func (b BaseObject).GetObjectValue() js.Value {
	if b.object != nil {
		return *b.object
	} else {
		return js.Undefined()
...
func (b BaseObject) ToString() (string, error) {
	var value js.Value
	var err error
	if b.GetObjectValue().Type() == js.TypeObject {
		if value = b.Call("toString"); value.Error() == nil {
			return value.String(), nil
		} else {
			return "", err
		}
...
func (b BaseObject) Bind(to BaseObject) (interface{}, error) {
	...
	if bindObj = b.Call("bind", to.GetObjectValue()); bindObj.Error() == nil {
...
func (b BaseObject) Implement(method string) (bool, error) {
	...
	if obj = b.GetValueByKey(method); obj.Error() == nil {
...
func (b BaseObject) Class() (string, error) {
	...
	if objconstructor = b.GetValueByKey("constructor"); objconstructor.Error() == nil {
...
func (b BaseObject) GetAttributeString(attribute string) (string, error) {
	...
	if obj = b.GetValueByKey(attribute); obj.Error() == nil {
		if obj.IsUndefined() {
...
func (b BaseObject) CallInt64(method string) (int64, error) {
	...
	if obj = b.Call(method); obj.Error() == nil {
		if obj.Type() == js.TypeNumber {
			ret = int64(obj.Float())
		} else {
			err = ErrObjectNotNumber
