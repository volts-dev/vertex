...
func (d Document) getAttributeElement(attribute string) (element.Element, error) {
	...
	if elemObject = d.GetValueByKey(attribute); elemObject.Error() == nil {
...
func (d Document) getAttributeHTMLCollection(attribute string) (htmlcollection.HtmlCollection, error) {
	...
	if obj = d.GetValueByKey(attribute); obj.Error() == nil {
...
func (d Document) Body() (htmlelement.HtmlElement, error) {
	...
	if bodyObject = d.GetValueByKey("body"); bodyObject.Error() == nil {
