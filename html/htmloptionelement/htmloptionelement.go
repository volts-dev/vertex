...
func GetInterface() js.Value {
	...
	singleton.Do(func() {
		...
		if htmloptionelementinterface = js.Global().Get("HTMLOptionElement"); htmloptionelementinterface.Error() != nil {
			htmloptionelementinterface = js.Undefined()
		}
		js.Register(htmloptionelementinterface, func(v js.Value) (interface{}, error) {
...
func Option(text string, opts ...interface{}) (HtmlOptionElement, error) {
	...
	if hci := js.Global().Get("Option"); hci.Error() == nil {
		var obj js.Value
