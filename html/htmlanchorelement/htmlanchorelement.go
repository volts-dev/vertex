...
func GetInterface() js.Value {
	...
	singleton.Do(func() {
		...
		if htmlanchorlementinterface = js.Global().Get("HTMLAnchorElement"); htmlanchorlementinterface.Error() != nil {
			htmlanchorlementinterface = js.Undefined()
		}
		js.Register(htmlanchorlementinterface, func(v js.Value) (interface{}, error) {
