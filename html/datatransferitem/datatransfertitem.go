...
func GetInterface() js.Value {
	...
	singleton.Do(func() {
		...
		if datatransferiteminterface = js.Global().Get("DataTransferItem"); datatransferiteminterface.Error() != nil {
			datatransferiteminterface = js.Undefined()
		}
		js.Register(datatransferiteminterface, func(v js.Value) (interface{}, error) {
...
func (d DataTransferItem) GetAsFile() (file.File, error) {
	...
	if obj = d.Call("getAsFile"); obj.Error() == nil {
