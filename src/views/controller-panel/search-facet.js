...
export class SearchFacet extends Element {
    ...
    if (filter.hasOptions) {
      if (filter.type === 'filter') {
        ...
        const sortFunction = (o1, o2) =>
          filter.options.findIndex(o => o.optionId === o1) -
          filter.options.findIndex(o => o.optionId === o2);
        const p = _.partition(
