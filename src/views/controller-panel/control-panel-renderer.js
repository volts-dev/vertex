import { AbstractRenderer } from '@/views/abstract_renderer';

class ControlPanelRenderer extends AbstractRenderer {
...
*/
  ...
  _setSearchMenusVisibility() {
    ...
    this.$('.o_search_options').toggleClass(
      'o_hidden',
