class TranslationDataBase {
  /** @lends instance.TranslationDataBase# */
  ...
  /**
        ...
        @returns {Promise}
    */
  load_translations(session, modules, lang, url) {
    var self = this;
