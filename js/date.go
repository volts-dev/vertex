...
func init() {
	...
	//js.RegisterInterface(GetDateInterface)
}
...
func GetDateInterface() Value {
	singletonDate.Do(func() {
		if dateinterface = Global().Get("Date"); dateinterface.Error() != nil {
			dateinterface = Undefined()
		}
		Register(dateinterface, func(v Value) (interface{}, error) {
...
func NewDate(values ...interface{}) (Date, error) {
	var d Date
	var err error
	...
	if di := GetDateInterface(); !di.IsUndefined() {
...
func NewDateFromJSObject(obj Value) (Date, error) {
	var d Date
	var err error
...
func (d Date) callString(method string, opts ...interface{}) (string, error) {
	...
	for _, opt := range opts {
		optJSValue = append(optJSValue, ValueOf(opt))
	}
...
func (d Date) SetDate(value int) error {
	...
	return d.Call("setDate", ValueOf(value)).Error()
}

func (d Date) SetFullYear(value int) error {

	return d.Call("setFullYear", ValueOf(value)).Error()
}

func (d Date) SetHours(value int) error {

	return d.Call("setHours", ValueOf(value)).Error()
}

func (d Date) SetMilliseconds(value int) error {

	return d.Call("setMilliseconds", ValueOf(value)).Error()
}

func (d Date) SetMinutes(value int) error {

	return d.Call("setMinutes", ValueOf(value)).Error()
}

func (d Date) SetSeconds(value int) error {

	return d.Call("setSeconds", ValueOf(value)).Error()
}

func (d Date) SetTime(value int64) error {

	return d.Call("setTime", ValueOf(value)).Error()
}

func (d Date) SetUTCDate(value int) error {

	return d.Call("setUTCDate", ValueOf(value)).Error()
}

func (d Date) SetUTCFullYear(value int) error {

	return d.Call("setUTCFullYear", ValueOf(value)).Error()
}

func (d Date) SetUTCHours(value int) error {

	return d.Call("setUTCHours", ValueOf(value)).Error()
}

func (d Date) SetUTCMilliseconds(value int) error {

	return d.Call("setUTCMilliseconds", ValueOf(value)).Error()
}

func (d Date) SetUTCMinutes(value int) error {

	return d.Call("setUTCMinutes", ValueOf(value)).Error()
}

func (d Date) SetUTCMonth(value int) error {

	return d.Call("setUTCMonth", ValueOf(value)).Error()
}

func (d Date) SetUTCSeconds(value int) error {
	return d.Call("setUTCSeconds", ValueOf(value)).Error()
}
...
func Parse(value string) (int64, error) {
	...
	var ret int64
	if di := GetDateInterface(); !di.IsUndefined() {
		if obj = di.Call("parse", ValueOf(value)); obj.Error() == nil {
...
func (d Date) ToLocaleDateString(opts ...interface{}) (string, error) {
	...
	if len(opts) > 0 {
		arrayopts = append(arrayopts, ValueOf(opts[0]))
	}

	if len(opts) > 1 {
		arrayopts = append(arrayopts, ValueOf(opts[1]))
	}
...
func NewDate_(values ...interface{}) Date {
	d, err := NewDate(values...)
