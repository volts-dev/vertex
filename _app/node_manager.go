...
import (
	...
	"github.com/volts-dev/vertex/temp/component"
)
...
func (m nodeManager) Mount(ctx context.Context, depth uint, v component.Component) (component.Component, error) {
	ctx = m.context(ctx, v)
...
func (m nodeManager) mountText(depth uint, v *text) (IComponent, error) {
	if v.Mounted() {
...
func (m nodeManager) mountHTML(ctx Context, depth uint, v HTML) (IComponent, error) {
	if v.Mounted() {
...
func (m nodeManager) renderComponent(v Composer) (IComponent, error) {
...
func (m nodeManager) mountRawHTML(depth uint, v *raw) (IComponent, error) {
	if v.Mounted() {
...
func (m nodeManager) Dismount(v IComponent) {
	switch v := v.(type) {
	case *text:
...
func (m nodeManager) CanUpdate(v, new IComponent) bool {
...
// process.
func (m nodeManager) Update(ctx Context, v, new IComponent) (IComponent, error) {
	if !v.Mounted() {
...
func (m nodeManager) updateText(v, new *text) (IComponent, error) {
...
func (m nodeManager) updateHTML(ctx Context, v, new HTML) (IComponent, error) {
	attrs := v.attrs()
	newAttrs := new.attrs()
...
func (m nodeManager) updateComponent(ctx Context, v, new Composer) (IComponent, error) {
...
func (m nodeManager) UpdateComponentRoot(ctx Context, v Composer) (IComponent, error) {
	ctx = m.context(ctx, v)
...
func (m nodeManager) updateRawHTML(ctx Context, v, new *raw) (IComponent, error) {
	if v.value == new.value {
		return v, nil
	}
...
func (m nodeManager) context(ctx Context, v IComponent) Context {
	ctx.sourceElement = v
...
func (m nodeManager) NotifyComponentEvent(ctx Context, root IComponent, event any) {
...
func (m nodeManager) encodeComponent(ctx Context, w *bytes.Buffer, depth int, v IComponent) {
	root := v.root()
	if root == nil {
