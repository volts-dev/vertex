...
func newEngine(ctx context.Context, routes *router.Router, resolveURL func(string) string, originPage *requestPage, actionHandlers map[string]ActionHandler) *engine {
...
func (e *engine) baseContext() Context {
	return Context{
		Context:               e.ctx,
...
// provided buffer.
func (e *engine) Encode(w *bytes.Buffer, document HTMLHtml) error {
	if e.body == nil {
