module github.com/volts-dev/vertex/examples/helloworld
...
require (
	github.com/volts-dev/vertex v0.0.0-20251014061541-62cd7872f547
	github.com/volts-dev/volts v0.0.0-20251015041220-7c1a12b04090
)
